...
- Windows:
	...
	- скачать архив с исполняемым файлом и вспомогательными данными:  https://github.com/raspberrypi/pico-sdk-tools/releases архив с названием pico-sdk-tools-2.2.0-x64-win.zip;
	- распаковать скаченный архив, запускать exe не нужно;
	- переместить папку в Program Files;
	- добавить путь к pioasm.exe в PATH;
	- проверить корректность ручной установки: ```pioasm --version```.
